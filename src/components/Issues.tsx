...
import { ExternalLink, ChevronLeft, ChevronRight, Search, Filter, X, Pipette, RailSymbol } from 'lucide-react';
import { Menu, Transition } from '@headlessui/react';
import { SiReact, SiKubernetes, SiTensorflow, SiProcessingfoundation, SiAppwrite, SiOpenfaas, SiOpenapiinitiative, SiApacheairflow, SiZulip, SiElectron, SiTldraw, SiElastic, SiStylelint, SiNumpy } from 'react-icons/si';
